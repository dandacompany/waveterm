...
| "cmd:cwd"              | (optional) A string representing the current working directory to be run with the command. Works locally and with WSL connections; SSH connections currently default to the home directory. Defaults to the home directory.                                                        |
