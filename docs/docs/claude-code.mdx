...
Wave already shows a bell icon when a terminal outputs a BEL character. These hooks complement that with semantic badges — _permission needed_, _done_ — that survive across tab switches and work across splits.
