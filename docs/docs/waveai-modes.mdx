...
:::note
The ai:endpoint is _NOT_ a baseurl. The endpoint should contain the full endpoint, not just the baseurl.
...
| `ai:endpoint`           | No       | _Full_ API endpoint URL (auto-set by provider when available)                                                                                               |
